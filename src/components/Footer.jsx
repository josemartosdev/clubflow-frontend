    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-grid">
          <div>
            <div className="footer-brand">
              <img src={`${import.meta.env.BASE_URL}img/logo-clubflow.svg`} alt={`Escudo ${CLUB.name}`} className="footer-logo" />
              <div className="footer-title">{CLUB.shortName.toUpperCase()} FC</div>
            </div>
            <p className="footer-desc">
              {CLUB.name}. Formación, competición y pasión por el fútbol en
              cada categoría de nuestra cantera.
            </p>
            <p className="footer-email">Email: {CLUB.email}</p>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><a href={`mailto:${CLUB.email}`}>Contacto</a></li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">&copy; {new Date().getFullYear()} {CLUB.name}. Todos los derechos reservados.</p>
          <div className="footer-links">
            <a href={`mailto:${CLUB.email}`}>Aviso legal</a>
            <a href={`mailto:${CLUB.email}`}>Política de privacidad</a>
          </div>
        </div>
      </div>
    </footer>
